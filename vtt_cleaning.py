...
def clean_vtt_content(content, remove_punctuation=False):
    ...
    cleaned_content = re.sub(r'\b(äh|ähs|ähm|hm|hmm)\b\s*[,;:\-\.]?\s*', '',
    ...
    if remove_punctuation:
        ...
        cleaned_content = re.sub(r'(?<!\d)[{}]+'.format(
            re.escape(punctuation_to_remove)), '', cleaned_content)
